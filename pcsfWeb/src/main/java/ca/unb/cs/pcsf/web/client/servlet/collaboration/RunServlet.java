 ...
 */
package ca.unb.cs.pcsf.web.client.servlet.collaboration;

import static ca.unb.cs.pcsf.web.client.PCSFWebClientConstants.COLLABORATION_STATE_RUNNING;
...
import ca.unb.cs.pcsf.web.client.PcsfUtils;
...
public class RunServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		pcsfUtils.callService(url, method, collaborationId);
