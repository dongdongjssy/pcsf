...
import static ca.unb.cs.pcsf.web.client.PCSFWebClientConstants.COLLABORATION_ATTRIBUTE_CREATOR_ID;
import static ca.unb.cs.pcsf.web.client.PCSFWebClientConstants.COLLABORATION_ATTRIBUTE_CURRENT_STATE;
import static ca.unb.cs.pcsf.web.client.PCSFWebClientConstants.COLLABORATION_ATTRIBUTE_NAME;
import static ca.unb.cs.pcsf.web.client.PCSFWebClientConstants.COLLABORATION_ATTRIBUTE_PARTICIPANT;
import static ca.unb.cs.pcsf.web.client.PCSFWebClientConstants.COLLABORATION_ATTRIBUTE_PROCESS_DEFINITION_ID;
import static ca.unb.cs.pcsf.web.client.PCSFWebClientConstants.COLLABORATION_ATTRIBUTE_WORKFLOW_MODEL;
import static ca.unb.cs.pcsf.web.client.PCSFWebClientConstants.CREATOR_ATTRIBUTE_EMAIL;
import static ca.unb.cs.pcsf.web.client.PCSFWebClientConstants.CREATOR_ATTRIBUTE_NAME;
import static ca.unb.cs.pcsf.web.client.PCSFWebClientConstants.CREATOR_ATTRIBUTE_PASSWORD;
import static ca.unb.cs.pcsf.web.client.PCSFWebClientConstants.CREDENTIAL_FILE_PATH;
import static ca.unb.cs.pcsf.web.client.PCSFWebClientConstants.DOMAIN_COLLABORATION;
import static ca.unb.cs.pcsf.web.client.PCSFWebClientConstants.DOMAIN_CREATOR;
import static ca.unb.cs.pcsf.web.client.PCSFWebClientConstants.DOMAIN_PARTICIPANT;
import static ca.unb.cs.pcsf.web.client.PCSFWebClientConstants.LOGPRE;
import static ca.unb.cs.pcsf.web.client.PCSFWebClientConstants.PARTICIPANT_ATTRIBUTE_COLLABORATION_ID;
import static ca.unb.cs.pcsf.web.client.PCSFWebClientConstants.PARTICIPANT_ATTRIBUTE_EMAIL;
import static ca.unb.cs.pcsf.web.client.PCSFWebClientConstants.PARTICIPANT_ATTRIBUTE_IS_REG;
import static ca.unb.cs.pcsf.web.client.PCSFWebClientConstants.PARTICIPANT_ATTRIBUTE_NAME;
